...
function LoginPage({onLogin}) {
    ...
    function onSubmit(data) {
        ...
        authService.loginProfesional(data.email, data.clave)
            .then(({profesional, token}) => {

                if(profesional === null && token === null) {
                    setValidador3(true);
                    ...
                    setTimeout(() => {
                        localStorage.setItem('profesional_id', profesional._id);
                    
                        onLogin(profesional, token);
    
                        navigate('/panel/'+ profesional._id);
                    }, 1800);
    ...
    return(
        <Grid flexDirection={'column'} container display={'flex'} justifyContent={'center'} alignItems={'center'}>
